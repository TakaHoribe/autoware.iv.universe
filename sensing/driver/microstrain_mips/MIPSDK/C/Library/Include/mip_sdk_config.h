...
///
// The maximum time the (in milliseconds) to wait for command/response cycles that require long processing on the device
// to complete (e.g. turning sub-device power on/off, running a BIT, etc.)
///
