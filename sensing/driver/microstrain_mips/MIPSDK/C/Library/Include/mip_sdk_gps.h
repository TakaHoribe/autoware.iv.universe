...
#define MIP_GPS_LLH_POS_PACKET_VALID                                                                       \
  (MIP_GPS_LLH_POS_LAT_LON_VALID | MIP_GPS_LLH_POS_ELLIPSOID_HEIGHT_VALID | MIP_GPS_LLH_MSL_HEIGHT_VALID | \
   MIP_GPS_LLH_POS_HORIZONTAL_ACCURACY_VALID | MIP_GPS_LLH_POS_VERTICAL_ACCURACY_VALID)
...
#define MIP_GPS_NED_VEL_PACKET_VALID                                                                      \
  (MIP_GPS_NED_VEL_VELOCITY_VALID | MIP_GPS_NED_VEL_SPEED_3D_VALID | MIP_GPS_NED_VEL_GROUND_SPEED_VALID | \
   MIP_GPS_NED_VEL_HEADING_VALID | MIP_GPS_NED_VEL_SPEED_ACCURACY_VALID | MIP_GPS_NED_VEL_HEADING_ACCURACY_VALID)
...
#define MIP_GPS_FIX_INFO_PACKET_VALID \
  (MIP_GPS_FIX_INFO_FIX_TYPE_VALID | MIP_GPS_FIX_INFO_NUM_SV_VALID | MIP_GPS_FIX_INFO_FIX_FLAGS_VALID)
...
#define MIP_GPS_SV_INFO_PACKET_VALID                                                                         \
  (MIP_GPS_SV_INFO_CHANNEL_VALID | MIP_GPS_SV_INFO_SV_ID_VALID | MIP_GPS_SV_INFO_CARRIER_NOISE_RATIO_VALID | \
   MIP_GPS_SV_INFO_AZIMUTH_VALID | MIP_GPS_SV_INFO_ELEVATION_VALID | MIP_GPS_SV_INFO_SV_FLAGS_VALID)
...
#define MIP_GPS_DOP_PACKET_VALID                                                                       \
  (MIP_GPS_DOP_GDOP_VALID | MIP_GPS_DOP_PDOP_VALID | MIP_GPS_DOP_HDOP_VALID | MIP_GPS_DOP_VDOP_VALID | \
   MIP_GPS_DOP_TDOP_VALID | MIP_GPS_DOP_NDOP_VALID | MIP_GPS_DOP_EDOP_VALID)
...
#define MIP_GPS_CLOCK_INFO_PACKET_VALID \
  (MIP_GPS_CLOCK_INFO_BIAS_VALID | MIP_GPS_CLOCK_INFO_DRIFT_VALID | MIP_GPS_CLOCK_INFO_ACCURACY_ESTIMATE_VALID)
...
#define MIP_GPS_HW_STATUS_PACKET_VALID \
  (MIP_GPS_HW_STATUS_SENSOR_STATE_VALID | MIP_GPS_HW_STATUS_ANTENNA_STATE_VALID | MIP_GPS_HW_STATUS_ANTENNA_POWER_VALID)
