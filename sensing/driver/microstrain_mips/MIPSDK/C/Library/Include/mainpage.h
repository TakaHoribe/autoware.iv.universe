...
//! into a single source file, which must be edited by the user to implement hardware-level calls (e.g. serial port
//! open, close, read, write, etc.)\n on their target platform.  The remaining files are target-agnostic, and can be
//! compiled on a wide range of platforms.\n This structure allows the user to develop across several platforms
//! easily.\n\n
//!
//! The SDK include a few key components:  a MIP parser, a callback interface for data packets, functions for assembling
//! and processing MIP packets,\n and high-level functions for performing descriptor-set-specific commands and
//! byte-swapping MIP data.
//!
//!
//! \n\n
