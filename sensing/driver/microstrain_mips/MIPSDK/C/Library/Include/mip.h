...
#define IS_MIP_FUNCTION_SELECTOR(SELECTOR)                                                                    \
  (((SELECTOR) == MIP_FUNCTION_SELECTOR_WRITE) || ((SELECTOR) == MIP_FUNCTION_SELECTOR_READ) ||               \
   ((SELECTOR) == MIP_FUNCTION_SELECTOR_STORE_EEPROM) || ((SELECTOR) == MIP_FUNCTION_SELECTOR_LOAD_EEPROM) || \
