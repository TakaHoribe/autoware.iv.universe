...
#define IS_FILTER_HEADING_SOURCE(SOURCE)                                                                   \
  (((SOURCE) == MIP_FILTER_HEADING_SOURCE_NONE) || ((SOURCE) == MIP_FILTER_HEADING_SOURCE_MAGNETOMETER) || \
   ((SOURCE) == MIP_FILTER_HEADING_SOURCE_GPS_VELOCITY) || ((SOURCE) == MIP_FILTER_HEADING_SOURCE_EXTERNAL))
...
#define IS_FILTER_HEADING_UPDATE_TYPE(TYPE) \
  (((TYPE) == MIP_FILTER_HEADING_UPDATE_TYPE_TRUE_NORTH) || ((TYPE) == MIP_FILTER_HEADING_UPDATE_TYPE_MAGNETIC_NORTH))
...
#define IS_FILTER_DECLINATION_SOURCE(SOURCE)                                                                \
  (((SOURCE) == MIP_FILTER_DECLINATION_SOURCE_NONE) || ((SOURCE) == MIP_FILTER_DECLINATION_SOURCE_MODEL) || \
...
#define IS_MIP_FILTER_EKF_DYNAMICS_MODE(MODE)                                                                  \
  (((MODE) == MIP_FILTER_EKF_DYNAMICS_MODE_PORTABLE) || ((MODE) == MIP_FILTER_EKF_DYNAMICS_MODE_AUTOMOTIVE) || \
...
#define IS_MIP_FILTER_EKF_BIAS_ESTIMATION_CONTROL(CONTROL)      \
  (((CONTROL) == MIP_FILTER_EKF_BIAS_ESTIMATION_CONTROL_OFF) || \
...
#define FILTER_HEADING_UPDATE_STATE_PACKET_VALID                                          \
  (FILTER_HEADING_UPDATE_STATE_SOURCE_VALID | FILTER_HEADING_UPDATE_STATE_HEADING_VALID | \
   FILTER_HEADING_UPDATE_STATE_HEADING_1SIGMA_VALID)
