...
namespace bev_optical_flow
{
  ...
  geometry_msgs::Vector3 Utils::kph2mptopic(const geometry_msgs::Vector3& twist,
                                            double topic_rate) {
    // convert twist to [km/h] from [m/topic_rate]
    geometry_msgs::Vector3 converted_twist;
  ...
  geometry_msgs::Point Utils::pixel2point(const geometry_msgs::Point point,
  ...
  geometry_msgs::Point Utils::pixel2point(const cv::Point2f& pixel,
                                          const cv::Size& image_size,
                                          float map2baselink_angle,
                                          int depth) {
  ...
  cv::Point2f Utils::getVehicleVel(const ros::Time& current_stamp,
