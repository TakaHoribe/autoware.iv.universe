...
template <class PointSource, class PointTarget>
void NormalDistributionsTransformOMP<PointSource, PointTarget>::setTransformationEpsilon(double trans_eps) {
...
template <class PointSource, class PointTarget>
double NormalDistributionsTransformOMP<PointSource, PointTarget>::getTransformationProbability() const {
...
template <class PointSource, class PointTarget>
Eigen::Matrix4f NormalDistributionsTransformOMP<PointSource, PointTarget>::getFinalTransformation() const {
...
template <class PointSource, class PointTarget>
ndt_omp::NeighborSearchMethod NormalDistributionsTransformOMP<PointSource, PointTarget>::getNeighborhoodSearchMethod()
    const {
