...
template <class PointSource, class PointTarget>
void NormalDistributionsTransformPCLModified<PointSource, PointTarget>::setMaximumIterations(int max_iter) {
...
template <class PointSource, class PointTarget>
void NormalDistributionsTransformPCLModified<PointSource, PointTarget>::setStepSize(double step_size) {
  ndt_ptr_->setStepSize(step_size);
}

template <class PointSource, class PointTarget>
void NormalDistributionsTransformPCLModified<PointSource, PointTarget>::setTransformationEpsilon(double trans_eps) {
...
template <class PointSource, class PointTarget>
double NormalDistributionsTransformPCLModified<PointSource, PointTarget>::getTransformationProbability() const {
...
template <class PointSource, class PointTarget>
Eigen::Matrix4f NormalDistributionsTransformPCLModified<PointSource, PointTarget>::getFinalTransformation() const {
