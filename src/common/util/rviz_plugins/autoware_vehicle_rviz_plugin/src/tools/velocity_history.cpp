...
std::unique_ptr<Ogre::ColourValue> VelocityHistoryDisplay::setColorDependsOnVelocity(const double vel_max, const double cmd_vel)
{
...
VelocityHistoryDisplay::VelocityHistoryDisplay()
{
  ...
  property_velocity_color_view_ = new rviz::BoolProperty("Constant Color", false, "", this, SLOT(updateVisualization()), this);
  property_velocity_color_ = new rviz::ColorProperty("Color", Qt::black, "", property_velocity_color_view_, SLOT(updateVisualization()), this);
