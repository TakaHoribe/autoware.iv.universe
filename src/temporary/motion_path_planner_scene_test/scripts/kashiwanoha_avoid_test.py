...
class AvoidTest:
    def __init__(self):
        ...
        self.scene_dir = rosparam.get_param("/kashiwanoha_avoid_test/scene_dir")
        self.scene_id = rosparam.get_param("/kashiwanoha_avoid_test/id")
        ...
        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        print('!!!!! start mono scenario test  !!!!')
        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n')
        ...
        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        print('!!!!! Finished mono scenario test !!!!!')
        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n')
    ...
    def run_test_mono(self):
        ...
        if res == 'goal':
            print '===== test result id :', self.scene_id, ' =====> SUCCESS (goal)\n'
        if res == 'collision':
            print '===== test result id :', self.scene_id, ' =====> FAIL (collision)\n'
        if res == 'timeout':
            print '===== test result id :', self.scene_id, ' =====> FAIL (timeout)\n'
