...
#include <new_trafficlight_recognizer/feat_proj_lanelet2/feat_proj_lanelet2_core.h>
...
void FeatProjLanelet2::init()
{
  ...
  roi_sign_pub_ = rosnode_.advertise<autoware_msgs::Signals>("roi_signal_a", 100);
