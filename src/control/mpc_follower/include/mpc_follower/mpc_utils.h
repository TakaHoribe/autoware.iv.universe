...
bool resampleMPCTrajectoryByDistance(const MPCTrajectory& input, const double resample_interval_dist,
...
void dynamicSmoothingVelocity(const int start_idx, const double start_vel, const double acc_lim, const double tau,
                              MPCTrajectory* traj);
 ...
 */
visualization_msgs::MarkerArray convertTrajToMarker(const MPCTrajectory& traj, std::string ns, double r, double g,
                                                    double b, double z, std::string& frame_id);
