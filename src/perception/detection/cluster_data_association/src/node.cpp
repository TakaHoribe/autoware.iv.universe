...
void ClusterDataAssociationNode::clusterCallback(
  ...
  Eigen::MatrixXd score_matrix = data_association_.calcScoreMatrix(*input_cluster1_msg, *input_cluster0_msg);
  data_association_.assign(score_matrix, direct_assignment, reverse_assignment);
  for (size_t cluster0_idx = 0; cluster0_idx < input_cluster0_msg->feature_objects.size(); ++cluster0_idx) {
  ...
  for (size_t cluster1_idx = 0; cluster1_idx < input_cluster1_msg->feature_objects.size(); ++cluster1_idx) {
