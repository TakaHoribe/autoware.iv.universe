...
private:
  ...
  std::vector<std::shared_ptr<message_filters::Subscriber<autoware_perception_msgs::DynamicObjectWithFeatureArray> > > v_roi_sub_;
  ...
  inline void
  dummyCallback(const autoware_perception_msgs::DynamicObjectWithFeatureArray::ConstPtr &input)
  {
