...
void RoiClusterFusionNodelet::onInit()
{
    ...
    {
        v_camera_info_sub_.push_back(std::make_shared<ros::Subscriber>(nh_.subscribe<sensor_msgs::CameraInfo>(
            "camera_info" + std::to_string(id), 1, boost::bind(&RoiClusterFusionNodelet::cameraInfoCallback, this, _1, id))));
    }
    ...
    {
    case 1:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), passthrough_, passthrough_, passthrough_, passthrough_, passthrough_, passthrough_, passthrough_);
        break;
    case 2:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), passthrough_, passthrough_, passthrough_, passthrough_, passthrough_, passthrough_);
        break;
    case 3:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), passthrough_, passthrough_, passthrough_, passthrough_, passthrough_);
        break;
    case 4:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), *v_roi_sub_.at(3), passthrough_, passthrough_, passthrough_, passthrough_);
        break;
    case 5:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), *v_roi_sub_.at(3), *v_roi_sub_.at(4), passthrough_, passthrough_, passthrough_);
        break;
    case 6:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), *v_roi_sub_.at(3), *v_roi_sub_.at(4), *v_roi_sub_.at(5), passthrough_, passthrough_);
        break;
    case 7:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), *v_roi_sub_.at(3), *v_roi_sub_.at(4), *v_roi_sub_.at(5), *v_roi_sub_.at(6), passthrough_);
        break;
    case 8:
        sync_ptr_ = std::make_shared<Sync>(SyncPolicy(10), cluster_sub_, *v_roi_sub_.at(0), *v_roi_sub_.at(1), *v_roi_sub_.at(2), *v_roi_sub_.at(3), *v_roi_sub_.at(4), *v_roi_sub_.at(5), *v_roi_sub_.at(6), *v_roi_sub_.at(7));
        break;
    default:
        return;
    }
    // sync_ptr_->registerCallback(boost::bind(&RoiClusterFusionNodelet::fusionCallback, this, _1, _2, _3, _4, _5, _6, _7, _8, _9));
    sync_ptr_->registerCallback(std::bind(&RoiClusterFusionNodelet::fusionCallback,
                                          this,
                                          std::placeholders::_1,
                                          std::placeholders::_2,
                                          std::placeholders::_3,
                                             ...
                                             const autoware_perception_msgs::DynamicObjectWithFeatureArray::ConstPtr &input_roi7_msg)
{
    ...
    for (int id = 0; id < (int)v_roi_sub_.size(); ++id)
    {
        ...
        intrinsic << m_camera_info_.at(id).K.at(0),
            m_camera_info_.at(id).K.at(1),
            m_camera_info_.at(id).K.at(2),
            m_camera_info_.at(id).K.at(3),
            m_camera_info_.at(id).K.at(4),
            m_camera_info_.at(id).K.at(5),
            m_camera_info_.at(id).K.at(6),
            m_camera_info_.at(id).K.at(7),
        ...
        try
        {
            transform_stamped = tf_buffer_.lookupTransform(/*target*/ m_camera_info_.at(id).header.frame_id, /*src*/ input_cluster_msg->header.frame_id,
                                                           ros::Time(0));
        }
        ...
        for (size_t i = 0; i < input_roi_msg->feature_objects.size(); ++i)
        {
            ...
            if (iou_threshold_ < max_iou &&
                output_msg.feature_objects.at(index).object.semantic.confidence <= input_roi_msg->feature_objects.at(i).object.semantic.confidence)
