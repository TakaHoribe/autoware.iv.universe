...
bool TrajectoryLoaderNode::publish(const std_msgs::Header &header, const association &label_row_association_map, const csv &file_data)
{
...
bool TrajectoryLoaderNode::loadData(const std::string &file_name, association &label_row_association_map, csv &file_data)
{
    file_data.clear();
