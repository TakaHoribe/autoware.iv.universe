...
class TrafficLightDebugMarkersManager {
 public:
  ...
  void pushTrafficLightState(const std::shared_ptr<const lanelet::TrafficLight>& traffic_light,
 ...
 private:
  ...
  std::vector<std::tuple<std::shared_ptr<const lanelet::TrafficLight>, autoware_traffic_light_msgs::TrafficLightState>>
