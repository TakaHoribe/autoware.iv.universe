...
bool findClosestIdxWithDistAngThr(const autoware_planning_msgs::Trajectory& in_trajectory,
                                  const geometry_msgs::Pose& curr_pose, int32_t& out_idx, double dist_thr,
                                  double angle_thr) {
...
geometry_msgs::Pose getPoseOnTrajectoryWithRadius(const autoware_planning_msgs::Trajectory& in_trajectory,
