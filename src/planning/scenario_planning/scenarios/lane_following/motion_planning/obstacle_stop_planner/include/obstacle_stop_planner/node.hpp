...
class ObstacleStopPlannerNode {
 ...
 private:
  ...
  double wheel_base_, front_overhang_, rear_overhang_, left_overhang_, right_overhang_, vehicle_width_;
  double stop_margin_;
 ...
 private:
  ...
  bool trimTrajectoryFromSelfPose(const autoware_planning_msgs::Trajectory& input_trajectory,
                                  ...
                                  autoware_planning_msgs::Trajectory& output_trajectory);
  bool trimTrajectoryWithIndexFromSelfPose(const autoware_planning_msgs::Trajectory& input_trajectory,
                                           const geometry_msgs::Pose self_pose,
