...
public:
  ...
  static Ptr make(Id id, const AttributeMap& attributes, const Polygons3d& detectionAreas,
...
private:
  ...
  DetectionArea(Id id, const AttributeMap& attributes, const Polygons3d& detectionAreas,
                       const LineString3d& stopLine);
