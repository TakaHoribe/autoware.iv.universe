...
GetFile::GetFile() : GetFile(HTTP_HOSTNAME, HTTP_PORT, HTTP_USER, HTTP_PASSWORD) {}
...
static FILE* cfile(buffer_t* const fb) { return (static_cast<io_buffer_t* const>(fb))->file(); }
