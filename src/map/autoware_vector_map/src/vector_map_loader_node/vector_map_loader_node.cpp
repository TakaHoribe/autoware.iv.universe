...
VectorMapLoaderNode::VectorMapLoaderNode() : nh_(""), private_nh_("~") {
  pub_binary_gpkg_map_ = nh_.advertise<BinaryGpkgMap>("autoware_vector_map/binary_gpkg_map", 1, true);
  ...
  const auto binary_gpkg_map = autoware_vector_map::bridge::bin2msg(gpkg_interface.toBinary(), "map", "", "");
