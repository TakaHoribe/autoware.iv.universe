...
#define AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(RELATIONSHIP, TABLE_NAME, LEFT_FEATURE_ID, RIGHT_FEATURE_ID) \
...
AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(LaneSectionConnection, lane_section_connections, lane_section_id,
                                               next_lane_section_id)

AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(LaneConnection, lane_connections, lane_id, next_lane_id)

AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(AdjacentLane, adjacent_lanes, lane_id, adjacent_lane_id)
AUTOWARE_VECTOR_MAP_REGISTER_GPKG_MEMBER(AdjacentLane, 2, type, "")

AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(Lane_StopLine, lanes_stop_lines, lane_id, stop_line_id)

AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(Lane_Crosswalk, lanes_crosswalks, lane_id, crosswalk_id)

AUTOWARE_VECTOR_MAP_REGISTER_GPKG_RELATIONSHIP(Lane_TrafficLight, lanes_traffic_lights, lane_id, traffic_light_id)
}  // namespace traits
}  // namespace autoware_vector_map
