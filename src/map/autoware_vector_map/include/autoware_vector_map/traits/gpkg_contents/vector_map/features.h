...
AUTOWARE_VECTOR_MAP_REGISTER_GPKG_MEMBER(Lane, 4, is_intersection, false)
AUTOWARE_VECTOR_MAP_REGISTER_GPKG_MEMBER(Lane, 5, is_left_turn, false)
AUTOWARE_VECTOR_MAP_REGISTER_GPKG_MEMBER(Lane, 6, is_right_turn, false)
